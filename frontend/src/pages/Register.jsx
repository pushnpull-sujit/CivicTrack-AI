              ...
              <div className="overflow-hidden rounded-[34px] bg-white text-slate-900 shadow-[0_40px_120px_rgba(1,6,20,0.4)]">
                <div className="bg-[linear-gradient(180deg,#f9fcff_0%,#ffffff_100%)] px-6 pt-8 sm:px-8 sm:pt-10">
                  ...
                  <div className="mt-2 text-center">
                    <h2 className="text-2xl font-extrabold text-slate-800 sm:text-3xl">Create Your Account</h2>
                    <p className="mt-2 text-sm text-slate-500 sm:text-base">Join CivicTrack AI to report and track civic issues</p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="mt-6 space-y-4 pb-6">
                    ...
                    <div className="text-center text-sm text-slate-500">
                      ...
                      <button onClick={onLoginRedirect} type="button" className="font-bold text-emerald-600 transition hover:text-emerald-700">
                        Sign In
                      </button>
                    </div>
